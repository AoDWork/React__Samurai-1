...
{/*    ====    45. Практика - connect, mapStateToProps, mapDispatchToProps     ====
    ...
    на следующем уроке будем разбираться. Думаю потому что state теперь обновляется как-то по другому. У меня дома все 
    заработало без дополнительных ухищрений.
