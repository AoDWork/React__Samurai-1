...
{/*    ====    11. Соц. сеть. Шаг 1(вёрстка, grid)     ====
    ...
    В контенте у нас должна быть хедер картинка на всю ширину, ниже аватарка, справа от аватарки данные пользователя(имя, данные),
        ...
        сайта, для расстановки элементов в content будем пользоваться другими технологиями например flexbox. Каждую картинку 
        оборачиваем в div чтобы потом можно было к каждой обратиться.
